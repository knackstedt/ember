export const IPC_CHANNELS = {
  ...
  splitscreen: {
    detectDisplays: "splitscreen:detectDisplays",
    getLayouts: "splitscreen:getLayouts",
    startSession: "splitscreen:startSession",
    stopSession: "splitscreen:stopSession",
    getSessionState: "splitscreen:getSessionState",
    pauseInstance: "splitscreen:pauseInstance",
    resumeInstance: "splitscreen:resumeInstance",
    stopInstance: "splitscreen:stopInstance",
    getAudioSinks: "splitscreen:getAudioSinks",
    setAudioSinkLabel: "splitscreen:setAudioSinkLabel",
    routeAudio: "splitscreen:routeAudio",
    assignDevice: "splitscreen:assignDevice",
    setHostDevice: "splitscreen:setHostDevice",
    locateDevice: "splitscreen:locateDevice",
    showOverlay: "splitscreen:showOverlay",
    hideOverlay: "splitscreen:hideOverlay",
    focusSlot: "splitscreen:focusSlot",
    state: "splitscreen:state",
    instanceProgress: "splitscreen:instanceProgress",
  },
} as const;
